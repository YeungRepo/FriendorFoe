...
if set_kernel:
    ...
    sample_kernel_bacterial_patch = (im_array_gray_bacterial_patch[685:715,685:715]) #(im_array_gray_bacterial_patch[600:650,600:650]) #np.array(im_array_gray_bacterial_patch[625:795,350:550])#
...
list_of_alphas = [4.4,30.0,26.5];#[3.75,13.0,5.1,8.5,8.2,11.25,4.06]

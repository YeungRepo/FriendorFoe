...
im = cv2.imread("../Data/Kernels/HCT116-Healthy_NC_10_2_20.tif");
...
im = cv2.imread("../Data/Kernels/HCT116-UnhealthyCell_BacterialPatch.tif");
...
if set_kernel:
    ...
    sample_kernel_healthy_HCT116 = im_array_gray_HCT116[250:350,650:750]
...
list_of_kernels = [mask_sample_kernel_healthy_HCT116,mask_sample_kernel_unhealthy_HCT116,mask_sample_kernel_bacterial_patch]

##[mask_sample_kernel_healthy_HCT116,mask_sample_kernel_healthy_dendritic,mask_sample_kernel_healthy_macrophage,mask_sample_kernel_unhealthy_HCT116,mask_sample_kernel_unhealthy_dendritic,mask_sample_kernel_unhealthy_macrophage,mask_sample_kernel_bacterial_patch]
...
for This_Pos_Flag in Pos_Flag:#This will be an iteration over elements like 'A1', 'A2', ... 
    ...
    for file_list_suffix in file_list_suffixes:
       ...
       #
        ...
        del(im);
        del(im_array_gray);
    output_file = open(Pickle_Path+'/'+exp_id+'_HCT116.pickle','wb')
